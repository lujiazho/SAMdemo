        ...
        <>
          {image || isToolBarUpload ? (
            <div className="flex items-stretch justify-center flex-1 overflow-hidden stage">
              ...
              />
              <div className="relative flex flex-col items-center justify-center flex-1 overflow-hidden md:overflow-visible md:px-3 md:py-0">
                <div className="absolute top-0 z-30 flex flex-col items-center justify-center w-full md:relative md:hidden">
                  <MobileOptionNavBar
                    handleResetInteraction={handleResetInteraction}
                    handleUndoInteraction={handleUndoInteraction}
                    handleRedoInteraction={handleRedoInteraction}
